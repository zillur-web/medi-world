		...
		3: function(t, e, n) {
			...
			var se = function() {
				...
				return e = t, (n = [{
					...
					value: function(t) {
						...
						return this.options.shortcuts && e ? (m.isMac && (e = e.replace("CMD", "Ã¢Å’Ëœ").replace("SHIFT", "Ã¢â€¡Â§")), " (" + (e = e.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")") : ""
					}
				}, {
					key: "button",
					value: function(t) {
			...
			var xe = function() {
				...
				return e = t, (n = [{
					...
					value: function() {
						var t = this.options.dialogsInBody ? this.$body : this.options.container,
							e = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.18</a> Ã‚Â· ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> Ã‚Â· ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
						this.$dialog = this.ui.dialog({
