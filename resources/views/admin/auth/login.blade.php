                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Enter {{ __('Email') }} Or Username" value="{{ old('email') }}" required autofocus autocomplete="username" />
                                @error('email')
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Enter {{ __('Password') }}" aria-describedby="password" />
